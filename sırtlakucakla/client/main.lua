	  ...
	  function(data, menu)
		  ...
		  if data.current.value == 'drag' then			
			  ...
			  if isKucak == false then
				  exports.pNotify:SendNotification({ text = "Kişiyi kucağına alıyorsun.", type = "info", timeout = 5000, layout = "topRight", queue = "right" })
				  isKucak2 = true;
			  elseif isKucak == true then
				  exports.pNotify:SendNotification({ text = "Kişiyi kucağından indiriyosun.", type = "error", timeout = 5000, layout = "topRight", queue = "right" })
			  ...
			  if hasRope == true then
				  ...
				  if distance ~= -1 and distance <= 3.0 then
					  ...
					  exports.pNotify:SendNotification({ text = "Yakında oyuncu yok.", type = "error", timeout = 5000, layout = "topRight", queue = "right" })
		  ...
		  if data.current.value == 'omuzla' then			
			  ...
			  if isKucak == false then
				  exports.pNotify:SendNotification({ text = "Kişiyi omzuna alıyorsun.", type = "info", timeout = 5000, layout = "topRight", queue = "right" })
  
				  isKucak = true;
			  elseif isKucak == true then
				  exports.pNotify:SendNotification({ text = "Kişiyi omzundan indiriyorsun.", type = "error", timeout = 5000, layout = "topRight", queue = "right" })
				  isKucak = false
			  end
			  ...
			  if hasRope == true then
				  ...
				  exports.pNotify:SendNotification({ text = "Halatın yok.", type = "error", timeout = 5000, layout = "topRight", queue = "right" })
